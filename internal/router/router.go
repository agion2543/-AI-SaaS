...
func Register(engine *gin.Engine, db *gorm.DB, cfg *config.Config) {
	...
	shareCtl := controller.NewShareController(shareService)
	...
	apiLegacy := engine.Group("/api")
	{
		...
		apiLegacy.POST("/merchant/password/send-code", merchantCtl.SendPasswordResetCode)
		apiLegacy.POST("/merchant/password/reset", merchantCtl.ResetPassword)
		...
		apiLegacy.GET("/customer/store/:storeId/coupons", orderCtl.PublicStoreCoupons)
		...
		apiLegacy.POST("/customer/orders/:orderNo/items", orderCtl.AppendCustomerOrderItems)
		apiLegacy.POST("/customer/orders/:orderNo/paid", orderCtl.MarkCustomerOrderPaid)
		apiLegacy.POST("/customer/orders/:orderNo/retry", orderCtl.RetryCustomerOrderPayment)
		apiLegacy.POST("/customer/orders/:orderNo/review", orderCtl.ReviewCustomerOrder)
		apiLegacy.POST("/customer/orders/:orderNo/share", shareCtl.CreateOrderShare)
		apiLegacy.POST("/share/:code/scan", shareCtl.TrackShareScan)
		...
		merchantLegacy.Use(middleware.Auth(cfg, "merchant"))
		{
			...
			merchantLegacy.POST("/subscription/orders/:orderNo/paid", merchantCtl.MarkSubscriptionOrderPaid)
			merchantLegacy.POST("/subscription/cards/redeem", merchantCtl.RedeemSubscriptionCard)
			merchantLegacy.PUT("/password", merchantCtl.ChangePassword)
			...
			merchantProtected.Use(middleware.MerchantSubscriptionMiddleware(db))
			{
				...
				merchantProtected.POST("/ai/referral-copy", merchantCtl.GenerateAIReferralCopy)
				merchantProtected.POST("/ai/share-review", merchantCtl.GenerateAIShareReview)
				merchantProtected.GET("/ai/share-stats", shareCtl.MerchantShareStats)
				merchantProtected.GET("/share/config", shareCtl.MerchantShareConfig)
				merchantProtected.PUT("/share/config", shareCtl.SaveMerchantShareConfig)
				merchantProtected.POST("/share/actions/amplify-offer", shareCtl.AmplifyShareOffer)
				merchantProtected.POST("/share/actions/optimize-poster", shareCtl.OptimizeSharePoster)
				merchantProtected.POST("/share/actions/disable-low-campaign", shareCtl.DisableLowShareCampaign)
				merchantProtected.GET("/coupons", shareCtl.MerchantCoupons)
				merchantProtected.PUT("/coupons/:id/redeem", shareCtl.RedeemMerchantCoupon)
				merchantProtected.PUT("/coupons/:id/void", shareCtl.VoidMerchantCoupon)
				...
				merchantProtected.POST("/products/upload-image", merchantCtl.UploadProductImage)
				...
				merchantProtected.GET("/settlements", orderCtl.MerchantSettlements)
				...
				merchantProtected.PUT("/orders/:id/confirm-payment", orderCtl.ConfirmMerchantOrderPayment)
		...
		adminLegacy.Use(middleware.Auth(cfg, "admin"))
		{
			...
			adminLegacy.GET("/merchant-follow-ups", adminCtl.MerchantFollowUpTodos)
			adminLegacy.GET("/merchants/:id/follow-ups", adminCtl.MerchantFollowUps)
			adminLegacy.POST("/merchants/:id/follow-ups", adminCtl.CreateMerchantFollowUp)
			adminLegacy.PUT("/merchant-follow-ups/:id/status", adminCtl.UpdateMerchantFollowUpStatus)
			...
			adminLegacy.POST("/orders/:id/confirm-subscription-payment", orderCtl.ConfirmMerchantSubscriptionPayment)
	...
	v1 := engine.Group("/api/v1")
	{
		...
		v1.POST("/merchant/password/send-code", merchantCtl.SendPasswordResetCode)
		v1.POST("/merchant/password/reset", merchantCtl.ResetPassword)
		...
		v1.GET("/customer/store/:storeId/coupons", orderCtl.PublicStoreCoupons)
		...
		v1.POST("/customer/orders/:orderNo/items", orderCtl.AppendCustomerOrderItems)
		v1.POST("/customer/orders/:orderNo/paid", orderCtl.MarkCustomerOrderPaid)
		v1.POST("/customer/orders/:orderNo/retry", orderCtl.RetryCustomerOrderPayment)
		v1.POST("/customer/orders/:orderNo/review", orderCtl.ReviewCustomerOrder)
		v1.POST("/customer/orders/:orderNo/share", shareCtl.CreateOrderShare)
		v1.POST("/share/:code/scan", shareCtl.TrackShareScan)
		...
		merchantGroup.Use(middleware.Auth(cfg, "merchant"))
		{
			...
			merchantGroup.POST("/subscription/orders/:orderNo/paid", merchantCtl.MarkSubscriptionOrderPaid)
			merchantGroup.POST("/subscription/cards/redeem", merchantCtl.RedeemSubscriptionCard)
			merchantGroup.PUT("/password", merchantCtl.ChangePassword)
		...
		adminGroup.Use(middleware.Auth(cfg, "admin"))
		{
			...
			adminGroup.GET("/merchant-follow-ups", adminCtl.MerchantFollowUpTodos)
			adminGroup.GET("/merchants/:id/follow-ups", adminCtl.MerchantFollowUps)
			adminGroup.POST("/merchants/:id/follow-ups", adminCtl.CreateMerchantFollowUp)
			adminGroup.PUT("/merchant-follow-ups/:id/status", adminCtl.UpdateMerchantFollowUpStatus)
			...
			adminGroup.POST("/orders/:id/confirm-subscription-payment", orderCtl.ConfirmMerchantSubscriptionPayment)
